...
class server():
    ...
    def localControl(self):
        ...
        while not self.remoteEnabled:
            ...
            l2 = robot.miscUtils.convertRange(-1.0, 1.0, robot.motor.MAX_SPEED, robot.motor.MIN_SPEED, self.controller.getAxisAt(robot.ds4.AXIS_L2))
            r2 = robot.miscUtils.convertRange(-1.0, 1.0, robot.motor.MAX_SPEED, robot.motor.MIN_SPEED, self.controller.getAxisAt(robot.ds4.AXIS_R2))
            motorSpeed = r2 - l2
